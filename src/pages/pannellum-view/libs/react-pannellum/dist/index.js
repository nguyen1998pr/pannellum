...
var pannellum = (function (window, document, undefined$1) {
  function Viewer(container, initialConfig) {
    ...
    let config,
      ...
      preview,
      isAdd = {},
      dTimeLookAtHotSpot = 400,
      dTimeZoomInHotSpot = 1000,
    ...
    function waitForView(dPitch, dYaw, dHfov) {
      var iCnt = 0;
      pI = Math.round(_this.getPitch()); // get actual pitch and round
      yI = Math.round(_this.getYaw()); // get actual yaw and round
      vI = Math.round(_this.getHfov()); // get actual Hfov and round
...
var changeMouseCursor = ReactPannellum.changeMouseCursor;
var showCompass = ReactPannellum.showCompass;
